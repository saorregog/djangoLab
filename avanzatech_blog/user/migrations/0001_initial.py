    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('blogger', 'Blogger'), ('admin', 'Admin')], default='blogger', max_length=7, verbose_name='role')),
                ('team', models.CharField(blank=True, max_length=30, verbose_name='team')),
